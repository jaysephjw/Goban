...
//  StoneColor player = StoneColor.Black;
...
//      if (clickedPlayer == StoneColor.Empty) {
//        var move = Move(player, pos);
//
//        gobanController.addMove(move);
//
//        setState(() {
//          player = player == StoneColor.Black ? StoneColor.White : StoneColor.Black;
//        });
//      }
//    });
//
